            ...
            <nav className="flex items-center justify-center h-40 translate-x-6">
                <div className="flex">
                    <div className="bg-[url('/glass1.png')] bg-no-repeat bg-center bg-contain translate-y-5 translate-x-7  p-1 flex" style={{backdropFilter: 'blur(20px)'}}>
                        <a href="/projects" className={`hover:text-[#FEF198] duration-300 -translate-y-0.5 ${anim.projects ? 'break-words hover:text-shadow-[0_4px_20px_rgba(255,239,120,0.4)]' : ''} text-2xl font-bold`}>Проекты</a>
                ...
                <div className="bg-[url('/glass2.png')] bg-no-repeat bg-center bg-contain p-1 flex translate-y-23">
                    <a href="/#main" className={`hover:text-[#FEF198] duration-300 -translate-y-0.5 break-words text-2xl font-bold
                ...
                <div className="bg-[url('/glass3.png')] bg-no-repeat bg-center bg-contain p-1 flex -translate-x-10">
                    <a href="/#about" className={`whitespace-nowrap hover:text-[#FEF198] duration-300 -translate-y-0.5 break-words 
                ...
                <div className="bg-[url('/glass4.png')] bg-no-repeat bg-center bg-contain p-1 flex translate-y-14 -translate-x-18">
                    <a href="/#contacts" className={`hover:text-[#FEF198] duration-300 -translate-y-0.5 break-words  text-2xl font-bold ${anim.contacts ? 'hover:text-shadow-[0_4px_20px_rgba(255,239,120,0.4)] ' : ''}`}>Контакты</a>
                    <div className={`absolute  w-3 h-50 -z-1 -translate-y-51 left-1/2 -translate-x-1/2
