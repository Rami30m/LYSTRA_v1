...
export default function ProjectsPage() {
    ...
    return (
        <div className="flex justify-center left-0 right-0 mt-10 overflow-x-hidden">
        ...
        Третий по величине международный Game Jam, который собрал более трех сотен участников в Satbayev University
                                    </p>
                                </div>
                            </div>
                            </Tilt>
